...
## BASE Result
execution time: IAR + RelationalAnalysis = 0.83 + 2.91 = 3.74 seconds
...
Output dim: 6, lower bound: -0.0282461, upper bound: 0.0282459
time: 2.31 seconds
...
DS_DSZ1, status: Status.VERIFIED, split count: 1, time: 4.61
Output dim: 6, lower bound: -0.0282461, upper bound: 0.0282459
DS_DSZ2, status: Status.VERIFIED, split count: 1, time: 4.61
Output dim: 6, lower bound: -0.0282461, upper bound: 0.0282459

## DS Result
status: Status.VERIFIED
execution time: (base) + (ds) = 3.74 + 4.61 = 8.35 seconds
