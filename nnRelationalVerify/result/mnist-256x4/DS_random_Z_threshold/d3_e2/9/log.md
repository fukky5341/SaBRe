...
## BASE Result
execution time: IAR + RelationalAnalysis = 0.93 + 6.01 = 6.94 seconds
...
Output dim: 1, lower bound: -1.8486766, upper bound: 1.8486766
time: 3.75 seconds
...
DS_DSZ1, status: Status.VERIFIED, split count: 1, time: 7.63
Output dim: 1, lower bound: -1.8486766, upper bound: 1.8486766
DS_DSZ2, status: Status.VERIFIED, split count: 1, time: 7.63
Output dim: 1, lower bound: -1.8486766, upper bound: 1.8486766

## DS Result
status: Status.VERIFIED
execution time: (base) + (ds) = 6.94 + 7.63 = 14.56 seconds
