...
## BASE Result
execution time: IAR + RelationalAnalysis = 1.28 + 0.98 = 2.26 seconds
...
NS_A1_B1, status: Status.VERIFIED, split count: 2, time: 1.84
Output dim: 0, lower bound: -1.8499806, upper bound: 1.8499806
NS_A1_B2, status: Status.VERIFIED, split count: 2, time: 1.84
Output dim: 0, lower bound: -1.8499806, upper bound: 1.8499806

## NS Result
status: Status.VERIFIED
execution time: (base) + (ns) = 2.26 + 2.54 = 4.80 seconds
