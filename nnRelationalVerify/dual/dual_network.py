...
from nnRelationalVerify.dual.dual_layers import DualLinear, DualConv2D, DualRelu
from nnRelationalVerify.dual.dual_analysis import DualAnalysis


def get_relational_order(net, C, RS_mode, layer_idx, input_shapes, inp1_lbs, inp1_ubs, inp2_lbs, inp2_ubs, d_lbs, d_ubs):
    ...
    if RS_mode is not None:
        ...
        rs_order = dual_analysis.estimate_relational_impact(dualnet_1, dualnet_2, RS_mode, layer_idx, inp1_lbs, inp1_ubs, inp2_lbs, inp2_ubs, d_lbs, d_ubs)
...
def get_relational_order_is(net, C, IS_mode, layer_idx, input_shapes, inp1_lbs, inp1_ubs, inp2_lbs, inp2_ubs, d_lbs, d_ubs):
    dualnet_1 = DualNetwork(C)
    dualnet_1.build_dual_network_relational(net, C, input_shapes, inp1_lbs, inp1_ubs, inp2_lbs, inp2_ubs, d_lbs, d_ubs)
    dualnet_2 = DualNetwork(-C)
    dualnet_2.build_dual_network_relational(net, -C, input_shapes, inp1_lbs, inp1_ubs, inp2_lbs, inp2_ubs, d_lbs, d_ubs)
    if IS_mode is not None:
        # get is order
        dual_analysis = DualAnalysis()
        is_order = dual_analysis.estimate_relational_impact_ns(dualnet_1, dualnet_2, layer_idx, inp1_lbs, inp1_ubs, inp2_lbs, inp2_ubs, d_lbs, d_ubs)
        ...
        return is_order  # is_order: [[is_type, lubs_layer_idx, pos], ...]
