...
class DualAnalysis_Ind:
    ...
    def estimate_individual_impact(self, dualnet_1, dualnet_2, layer_idx, lbs, ubs):
        ...
        return is_order: [[is_inp, lubs_layer_idx, pos], ...], e.g., [['A', 3, 10], ['B', 3, 10], ...]
        """
        ...
        is_order = self.arrange_in_descending_order_ns(unstable_mask, combined_score, idx)
        # is_order = [[lubs_layer_idx, pos], ...]

        return is_order  # is_order: [[is_inp, lubs_layer_idx, pos], ...]
    ...
    def arrange_in_descending_order_ns(self, unstable_mask, ds_scores, preactivation_lubs_idx):
        ...
        for item in sorted_scores:
            sorted_order.append(['A', preactivation_lubs_idx, item[0]])  # [is_inp, lubs_layer_idx, pos]
            # sorted_order.append(['B', preactivation_lubs_idx, item[0]])  # [is_inp, lubs_layer_idx, pos]

        return sorted_order  # [[is_inp, lubs_layer_idx, pos], ...]
