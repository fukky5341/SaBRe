...
from nnRelationalVerify.dual.dual_layers_ind import DualLinear_Ind, DualConv2D_Ind, DualRelu_Ind
from nnRelationalVerify.dual.dual_analysis_ind import DualAnalysis_Ind


def get_relational_order_is_ind(net, C, IS_mode, layer_idx, input_shapes, inp1_lbs, inp1_ubs):
    ...
    if IS_mode is not None:
        ...
        is_order = dual_analysis.estimate_individual_impact(dualnet_1, dualnet_2, layer_idx, inp1_lbs, inp1_ubs)
